...
<html lang="en">
    ...
    <body>
        ...
        <div class="tab">
            <button class="tablinks" onclick="openWatch(event, 'Future Watching')">Future Watching</button>
            <button class="tablinks" onclick="openWatch(event, 'Currently Watching')" id="defaultOpen">Currently Watching</button>
